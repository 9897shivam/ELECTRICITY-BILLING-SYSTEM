    ...
    Signup(){
        ...
        meter.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent fe) {
                try {
                    Conn c  = new Conn();
                    ResultSet rs = c.s.executeQuery("select * from login where meter_nov = '"+meter.getText()+"'");
                    while(rs.next()) {
        ...
        if (ae.getSource() == create) {
            ...
            try {
                ...
                if (atype.equals("Admin")) {
                    ...
                    query = "update login set username = '"+susername+"', password = '"+spassword+"', user = '"+atype+"' where meter_nov = '"+smeter+"'";
                }
